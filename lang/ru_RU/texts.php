...
$lang = array(
    ...
    'payment_terms' => 'Платеж Условия',
    'currency_id' => 'Валюта',
    'size_id' => 'Размер компании',
    'industry_id' => 'Промышленность',
    'private_notes' => 'Частные заметки',
    'invoice_date' => 'Счет Дата',
...
<li>"Вознаграждение за  :QUARTER+1 квартал" => "Вознаграждение за 2 квартал"</li>
    ...
    'new_recurring_quote' => 'Новая Повторяющийся цитата',
    'recurring_quote' => 'Повторяющийся цитата',
    ...
    'recurring_hour' => 'Повторяющийся Час',
    'pattern' => 'Шаблон',
    ...
    'archive_recurring_invoice' => 'Архив Повторяющийся Счет',
    'archived_recurring_invoice' => 'Успешно архивированный Повторяющийся Счет',
    'delete_recurring_invoice' => 'Удалить Повторяющийся Счет',
    'deleted_recurring_invoice' => 'Успешно Удалён Повторяющийся Счет',
    'restore_recurring_invoice' => 'Восстанавливать Повторяющийся Счет',
    ...
    'show_archived_users' => 'Показать архивированный пользователей',
    'notes' => 'Заметки',
    'invoice_will_create' => 'Счет будет созданы',
    ...
    'next_invoice_number' => 'Следующий номер Счет — :number .',
    'next_quote_number' => 'Следующий номер котировки — :number .',
    'days_before' => 'дней до',
    'days_after' => 'дней после',
    'field_due_date' => 'cрок оплаты',
    'field_invoice_date' => 'Счет дата',
    'schedule' => 'Расписание',
    'email_designs' => 'Дизайн E-mail',
    'assigned_when_sent' => 'Назначается при отправке',
    ...
    'expense_amount' => 'Сумма расходы',
    'expense_balance' => 'расходы Баланс',
...
<li> Сегодня пятница, срок сдачи — первая пятница после. Срок сдачи — следующая пятница, а не сегодня.
    ...
    'quote_settings' => 'Цитата Настройки',
...
Успешно созданы  :count_vendors Поставщик(и) и  :count_expenses и расход(ы)',
    ...
    'invitation_status_sent' => 'Отправил',
    ...
    'expired' => 'Истекший',
    'invalid_card_number' => 'Номер кредитной карты недействителен.',
    'invalid_expiry' => 'Срок годности недействителен.',
    'invalid_cvv' => 'CVV недействителен.',
    'cost' => 'Расходы',
    'create_invoice_for_sample' => 'Примечание : Создать свой первый Счет к просмотреть предварительный просмотр здесь.',

    // User Permissions
    'owner' => 'Владелец',
    'administrator' => 'Администратор',
    'administrator_help' => 'Разрешить Пользователь к пользователями, изменять Настрой <span class=\'notranslate\'>к и</span> изменять все записи',
    'user_create_all' => 'Создать Клиенты , Счета и т. д.',
    'user_view_all' => 'Смотреть все Клиенты , Счета и т.д.',
    'user_edit_all' => 'Редактировать все Клиенты , Счета и т.д.',
    ...
    'create_all_help' => 'Разрешить Пользователь к и изменять Создать',
    'view_all_help' => 'Разрешить Пользователь к записи Смотреть которые он не Создать',
    'edit_all_help' => 'Разрешить Пользователь к записи, которые он не Создать',
 ...
 Получив необходимые суммы, вернитесь к страницу «Способы Платеж и нажмите «Завершить проверку» рядом к нужным счетом.',
    ...
    'archived_recurring_expense' => 'Успешно архивированный Повторяющийся расходы',
    'restore_recurring_expense' => 'Восстанавливать Повторяющийся расходы',
    'restored_recurring_expense' => 'Успешно Восстановлен Повторяющийся расходы',
    'delete_recurring_expense' => 'Удалить Повторяющийся расходы',
    ...
    'time_tracker_mobile_help' => 'Дважды коснитесь Задача к выбрать ее',
    'stopped' => 'Остановлено',
    ...
    'show_tasks_in_portal' => 'Показать задачи на клиента портале',
    ...
    'subscription_event_18' => 'созданы Задача',
    'subscription_event_19' => 'Обновленная Задача',
    'subscription_event_20' => 'Удалён Задача',
    ...
    'module_recurring_invoice' => 'Повторяющийся Счета',
    ...
    'auto_email_invoice_help' => 'Автоматически E-mail Повторяющийся Счета при созданы .',
    ...
    'custom_task_fields_help' => 'Добавить поле при создании Задача .',
    ...
    'activity_63' => ':user отправил первое напоминание по электронной почте для Счет :invoice к :contact',
    'activity_64' => ':user отправил второе напоминание по электронной почте для Счет :invoice к :contact',
    ...
    'please_type_to_confirm' => 'Пожалуйста, введите &quot; :value &quot; к подтверждения',
    'purge' => 'Удалять',
    'clone_to' => 'Клон к',
    ...
    'download_timeframe' => 'Используйте эту ссылку к загрузки файлов, срок действия ссылки истекает через 1 час.',
    'new_signup' => 'Новая регистрация',
    'new_signup_text' => 'нового аккаунт созданы пользователем :user - :email - с IP-адреса: :ip',
    ...
    'notification_payment_paid' => 'Платеж :amount был сделан клиента :client в сторону :invoice',
    'notification_partial_payment_paid' => 'Частичный Платеж :amount был сделан клиента :client в сторону :invoice',
    'notification_bot' => 'Уведомляющий бот',
    'invoice_number_placeholder' => 'Счет # :invoice',
    'entity_number_placeholder' => ':entity # :entity _номер',
    'email_link_not_working' => 'Если кнопка выше не работает у вас, нажмите на ссылку',
    'display_log' => 'Журнал отображения',
    'send_fail_logs_to_our_server' => 'Сообщить об ошибках к помочь улучшить приложение',
    'setup' => 'Настраивать',
    'quick_overview_statistics' => 'Краткий обзор и статистика',
    'update_your_personal_info' => 'Обновите свою личную информацию',
    'name_website_logo' => 'Название, веб-сайт и логотип',
    'make_sure_use_full_link' => 'Обязательно используйте полную ссылку к ваш сайт.',
    'personal_address' => 'Личный адрес',
    'enter_your_personal_address' => 'Ввод ваш личный адрес',
    'enter_your_shipping_address' => 'Ввод ваш адрес доставки',
    'list_of_invoices' => 'Список Счета',
    'with_selected' => 'С выбранным',
    'invoice_still_unpaid' => 'Этот Счет еще не оплачен. Нажмите кнопку к завершения Платеж',
    'list_of_recurring_invoices' => 'Список Повторяющийся Счета',
    'details_of_recurring_invoice' => 'Вот некоторые детали о Повторяющийся Счет',
    'cancellation' => 'Отмена',
    ...
    'list_of_payments' => 'Список Платежи',
    'payment_details' => 'детали Платеж',
    'list_of_payment_invoices' => 'Associate Счета',
    'list_of_payment_methods' => 'Список методов Платеж',
    'payment_method_details' => 'детали метода Платеж',
    'permanently_remove_payment_method' => 'Удалите этот метод Платеж навсегда.',
    'warning_action_cannot_be_reversed' => 'Внимание! Это действие не может быть отменено!',
    'confirmation' => 'Подтверждение',
    'list_of_quotes' => 'Кавычки',
    'waiting_for_approval' => 'Ожидание одобрения',
    'quote_still_not_approved' => 'Эта цитата все еще не Одобрено',
    ...
    'env_not_writable' => 'Файл .env недоступен для записи текущему Пользователь .',
    ...
    'complete_your_payment' => 'Полная Платеж',
    ...
    'payment_failed_subject' => 'Платеж не удался для Клиент :client',
    ...
    'credit_card_invalid' => 'Предоставленный номер кредитной карты недействителен.',
    ...
    'to_pay_invoices' => 'к оплате Счета , у тебя есть к',
    'add_payment_method_first' => 'Добавить метод Платеж',
    'no_items_selected' => 'Элементы не выбраны.',
    'payment_due' => 'Платеж из-за',
    'account_balance' => 'Баланс счета',
    'thanks' => 'Спасибо',
    'minimum_required_payment' => 'Минимальная требуемая Платеж составляет :amount',
    ...
    'credit_message' => 'к Смотреть свой кредит для :amount , нажав на ссылку ниже.',
    'payment_type_Crypto' => 'Криптовалюта',
    'payment_type_Credit' => 'Кредит',
    'store_for_future_use' => 'Сохранить для будущего использования',
    'pay_with_credit' => 'Оплатить кредитом',
    'payment_method_saving_failed' => 'Метод Платеж нельзя сохранить для дальнейшего использования.',
    'pay_with' => 'Оплатить с помощью',
    'n/a' => 'Н/Д',
    'by_clicking_next_you_accept_terms' => 'Нажимая «Далее» вы принимаете Условия .',
    'not_specified' => 'Не указан',
    'before_proceeding_with_payment_warning' => 'Прежде чем продолжить Платеж , вам к заполнить следующие поля',
    'after_completing_go_back_to_previous_page' => 'После завершения вернитесь к предыдущую страницу.',
    'pay' => 'Платить',
    ...
    'required_payment_information' => 'Требуется Платеж детали',
    'required_payment_information_more' => 'к завершения Платеж нам нужно больше детали о вас.',
    'required_client_info_save_label' => 'Мы Сохранить это, чтобы вам не Ввод к в следующий раз.',
    'notification_credit_bounced' => 'Мы не смогли к Кредит :invoice к :contact .\n :error',
    'notification_credit_bounced_subject' => 'Невозможно к Кредит :invoice',
    'save_payment_method_details' => 'Метод Сохранить Платеж детали',
    ...
    'credit_number_taken' => 'Номер кредита уже занят',
    ...
    'payment_id_required' => 'Требуется `id` Платеж .',
    'unable_to_retrieve_payment' => 'Невозможно к указанный Платеж',
    ...
    'no_group_settings_found' => 'Группа Настройки не найдена',
    ...
    'quote_not_found' => 'Цитата/ы не найдены',
    'quote_unapprovable' => 'к одобрить эту смету, так как срок ее действия истек.',
    ...
    'create_webhook_failure' => 'Создать к',
    ...
    'select_a_gmail_user' => 'Пожалуйста, выберите Пользователь аутентифицированного с помощью Gmail.',
    ...
    'show_tasks_in_client_portal' => 'Показать задачи на Клиент портале',
    ...
    'allow_billable_task_items_help' => 'Включить настройку того, какие элементы Задача будут выставлены счетами',
    'show_task_item_description' => 'Показать описание пункта Задача',
    'show_task_item_description_help' => 'Включить указание описаний элементов Задача',
    ...
    'task_extension_banner' => 'Добавить расширение Chrome к управления задачами.',
    ...
    'upcoming_recurring_invoices' => 'Предстоящие Повторяющийся Счета',
    ...
    'task_round_to_nearest_help' => 'Интервал к раунду Задача к .',
